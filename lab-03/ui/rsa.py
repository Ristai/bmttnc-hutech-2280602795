...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1093, 455)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(470, 40, 191, 51))
        font = QtGui.QFont()
        ...
        self.txt_plaintext.setGeometry(QtCore.QRect(120, 150, 371, 101))
        ...
        self.txt_ciphertext.setGeometry(QtCore.QRect(120, 270, 371, 101))
        self.txt_ciphertext.setObjectName("txt_ciphertext")
        self.txt_information = QtWidgets.QTextEdit(Dialog)
        self.txt_information.setGeometry(QtCore.QRect(660, 150, 371, 101))
        self.txt_information.setObjectName("txt_information")
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(570, 150, 81, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.txt_signature.setGeometry(QtCore.QRect(660, 270, 371, 101))
        self.txt_signature.setObjectName("txt_signature")
        self.label_5 = QtWidgets.QLabel(Dialog)
        self.label_5.setGeometry(QtCore.QRect(570, 270, 71, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(130, 390, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(400, 390, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.btn_sign.setGeometry(QtCore.QRect(670, 390, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.btn_generatekeys.setGeometry(QtCore.QRect(660, 100, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
